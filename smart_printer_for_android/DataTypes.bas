...
Sub Process_Globals
	...
	Type PaymentButton(ID As Int, Name As String, PaymentMethod As Int, FiscalMode As Int, CompanyID As Int)
	...
	Type information(country As String, language As String, Device As String, port As String, speed As String, IPaddress As String, codeTable As String, operator As String, password As String, headerOne As String)
