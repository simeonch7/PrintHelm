...
'Code module
Sub Process_Globals
	Public Const BMP_SpinnerBack, BMP_PrinterIcon1, BMP_PrinterIcon2, BMP_PrinterIcon3, BMP_PrintItemIconError, BMP_PrintItemIconSuccess, BMP_PrintItemIconPressed As Bitmap
End Sub
